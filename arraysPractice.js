...
//Have divider return an Array with the first item in the array being the evens array (all the even values from nums) and the second item
// in the Array being the odds array(all the odd values from nums).


  function divider(numbersArray) {
    var evenArray = [];
    var oddArray = [];
    var uberArray = [evenArray, oddArray];
...
//Above you're given a function that will return a random number between 0 and 30.  There is also a commented out array full of numbers to help you visualize what your function
// will be receiving.
...
/*
  ...
  In both the removeItem function and the addItem function, you will also need to check for valid arguments. Specrunner will try to call
  your functions without passing in valid arguments. When this happens, you will need to respond by returning an empty array.
*/
...
var user2 = {
    name: 'Bucky Bochamp',
    email: 'buckybochamp@gmail.com',
    password: 'iLoveBuckyBo',
    username: 'BuckyBo'
};
